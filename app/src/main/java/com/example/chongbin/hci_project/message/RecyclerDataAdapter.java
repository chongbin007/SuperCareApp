...
import com.example.chongbin.hci_project.DialogActivity;
import com.example.chongbin.hci_project.HospitalActivity;
import com.example.chongbin.hci_project.MainActivity;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.tv_parentName) {
                ...
                //Toast.makeText(context, "sdklfjgn" + textViewClicked.getText().toString(), Toast.LENGTH_SHORT).show();
